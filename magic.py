...
=============================================
由python-magic-0.4.3修改而来
主要是在调用libmagic函数前，对文件路径进行编码
所以要求传入的参数为字符串
2013-05-16 14:30:00
=============================================
"""
...
class Magic:
    ...
    def __init__(self, mime=False, magic_file=None, mime_encoding=False):
        ...
        magic_load(self.cookie, magic_file.encode( os.sys.getfilesystemencoding() ))
    ...
    def from_file(self, filename):
        ...
        return magic_file(self.cookie, filename.encode( os.sys.getfilesystemencoding() ))
